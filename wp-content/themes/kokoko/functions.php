...
function twentyseventeen_scripts() {
    ...
    wp_enqueue_style( 'font', 'https://fonts.googleapis.com/css?family=Open+Sans:400,600,700,800&amp;subset=cyrillic-ext', array(), null );
    ...
    wp_enqueue_style( 'kokoko', get_template_directory_uri() . '/assets/css/kokoko.css', array(), null );
    ...
    wp_enqueue_script( 'maskedinput', get_template_directory_uri() . '/assets/js/jquery.maskedinput.min.js', array(), null, true );
    wp_enqueue_script( 'jqBootstrapValidation', get_template_directory_uri() . '/assets/js/jqBootstrapValidation.min.js', array(), null, true );
    wp_enqueue_script( 'contact', get_template_directory_uri() . '/assets/js/contact.js', array(), null, true );
    wp_enqueue_script( 'kokoko', get_template_directory_uri() . '/assets/js/kokoko.js', array(), null, true );
}
...
add_filter('nav_menu_css_class', 'add_menu_list_item_class', 200, 3);
...
add_filter( 'nav_menu_link_attributes', 'add_menu_link_class', 200, 3 );
...
function ajax_form(){
    ...
    $subject = get_bloginfo('name') . ' "Заявка"';
    $body = "Имя: " . $name . "<br/>";
    $body .= "Телефон: " . $phone . "<br/>";
    $body .= "Сайт: " . $site;
    $mail_to = get_field('email', 2);
